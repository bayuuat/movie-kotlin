...
public final class ActivityAuthBinding implements ViewBinding {
  ...
  @NonNull
  public final FragmentContainerView AuthFragment;

  private ActivityAuthBinding(@NonNull ConstraintLayout rootView,
      @NonNull FragmentContainerView AuthFragment) {
  ...
  public static ActivityAuthBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      FragmentContainerView AuthFragment = ViewBindings.findChildViewById(rootView, id);
      if (AuthFragment == null) {
        break missingId;
      }

      return new ActivityAuthBinding((ConstraintLayout) rootView, AuthFragment);
    }
